...
from core.models import Subject, UserSubject, UserLesson, User, UserTask, UserTheory, UserVideo, \
...
def user_subject_detail_view(request, user_subject_id):
    ...
    return render(request, 'app/dashboard/teacher/user_subject/page.html', context)
